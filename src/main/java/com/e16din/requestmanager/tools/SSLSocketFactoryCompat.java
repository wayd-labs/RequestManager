package com.e16din.requestmanager.tools;
...
//from https://gitlab.com/bitfireAT/davdroid/blob/93464ccf8c7d98cb1af81e51811c337db43eef92/app/src/main/java/at/bitfire/davdroid/SSLSocketFactoryCompat.java
public class SSLSocketFactoryCompat extends SSLSocketFactory {
    ...
    private void upgradeTLS(SSLSocket ssl) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP && cipherSuites != null) {
            Log.d("SSLSocketFactoryCompat", "Setting allowed TLS ciphers for Android <5: " + TextUtils.join(", ", protocols));
